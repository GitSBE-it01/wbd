...
const cellBtn = (src,data, tblStyle) => {
    ...
    btn.textContent = data.param.text;
...
const cellDiv = (src,data, tblStyle) => {
    ...
    div.setAttribute('data-row', data.mark.text + "___" +src[data.mark.dbfield]);
    div.id = data.mark.text + "___" +src[data.mark.dbfield];
    return div;
}
