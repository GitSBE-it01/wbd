...
if(mysqli_query($conn_form_pinjam, $sql)){
    $sql = "SELECT username, nama FROM list_verifikasi WHERE id_pinjam=$id_pinjam AND id <> $id AND username <> $user_login";
    $result = $conn_list_user->query($sql);
    $result_data = $result->fetch_assoc();
    while ($result_data_loop = $result_data->fetch_assoc()) {
