...
if(mysqli_query($conn_form_pinjam, $sql)){
    $sql1 = "SELECT username, nama, email FROM list_verifikasi WHERE id_pinjam=$id";
    ...
    $sql1 = "SELECT created_id, peminta_id, nama_created, email_created, nama_peminta, email_peminta FROM datapeminta WHERE id=$id";
    $result = $conn_form_pinjam->query($sql1);
