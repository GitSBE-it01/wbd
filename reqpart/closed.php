            ...
            <div class="card-body">
              ...
              <tbody>
                ...
                while ($row_result_data_peminta = $result_data_peminta->fetch_assoc()) {
                  ...
                  echo'<tr><td>'.$row_result_data_peminta["divisi_peminta"].' '.$row_result_data_peminta["nama_peminta"].'</td> 
                      <td>';
                  ...
                  while ($row_result_list_verifikasi = $result_list_verifikasi->fetch_assoc()) {
                    ...
                    if ($row_result_list_verifikasi["status_verifikasi"] == 0){
                      echo '<b>Nama: </b> '.$row_result_list_verifikasi["nama"].'<br><b>Divisi: </b>'.$row_result_list_verifikasi["divisi"].'<br><b>Status:</b> <img src="assets/img/pending.png" class="rounded-circle" style="width: 30px"> <hr>';
                    }
