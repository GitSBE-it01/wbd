...
$update = Comp::dtlist(['id'=>'jig_list'])
    ...
    ".Comp::header([
        ...
        'body'=>[
            Comp::div([
                'class'=>'flex flex-row h-[5vh] w-full bg-teal-700 items-center',
                'body'=>[
                    Comp::div([
                        'id'=>'stock_switch',
                        'class'=>'flex flex-1 cursor-pointer hover:bg-teal-600 justify-center items-center h-[5vh] items-center duration-300 hover:text-xl hover:font-bold text-white bg-teal-600 text-xl font-bold',
                        'body'=>'Detail Stock'
                    ]),
                    Comp::div([
                        'id'=>'detail_switch',
                        'class'=>'flex flex-1 cursor-pointer hover:bg-teal-600 justify-center items-center h-[5vh] items-center duration-300 hover:text-xl hover:font-bold text-white bg-teal-800 ',
                        'body'=>'Detail Jig'
                    ]),
                    Comp::div([
                        'id'=>'type_switch',
                    ...
                    Comp::div([
                        ...
                        'body'=>[
                            ...
                            Comp::button([
                                'id'=>'search_stock',
                                'body'=>'search',
                                'class'=>'rounded bg-gray-300 w-[10vw] text-sm border-2 border-slate-400 shadow-md hover:font-semibold hover:bg-teal-200 duration-300'
                            ]),
                            Comp::button([
                                'id'=>'submit_stock',
                                'body'=>'submit',
                                'disable'=>'',
                                'class'=>'rounded text-slate-200 bg-gray-300 w-[10vw] text-sm border-2 hover:bg-teal-200 border-slate-400 shadow-md hover:font-semibold duration-300'
                            ]),
                            Comp::button([
                                'id'=>'add_new_stock',
                                'body'=>'add new',
                                'class'=>'rounded bg-gray-300 hover:bg-teal-200 w-[10vw] text-sm border-2 border-slate-400 shadow-md hover:font-semibold duration-300'
                            ]),
                        ]
                    ]),
                    Comp::div([
                        ...
                        'body'=>[
                            ...
                            Comp::button([
                                'id'=>'search_detail',
                                'body'=>'search',
                                'class'=>'rounded bg-gray-300 w-[10vw] text-sm border-2 border-slate-400 shadow-md hover:font-semibold duration-300 hover:bg-teal-200'
                            ]),
                            Comp::button([
                                'id'=>'submit_detail',
                                'body'=>'submit',
                                'disable'=>'',
                                'class'=>'rounded text-slate-200 bg-gray-300 w-[10vw] text-sm border-2 border-slate-400 shadow-md hover:font-semibold duration-300 hover:bg-teal-200'
                            ]),
                            Comp::button([
                                'id'=>'edit_detail',
                                'body'=>'edit',
