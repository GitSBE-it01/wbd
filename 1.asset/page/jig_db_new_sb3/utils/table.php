    ...
    'data_array'=> [
        [
            ...
            'th'=>[
                ...
                'class'=>'bg-teal-700 border-2 text-white uppercase border-black p-2 sticky left-0 top-0 z-20',
            ],
            'td'=>[
                'name'=>'item_jig',
        ...
        [
            ...
            'th'=>[
                'body'=>'Desc Jig',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10'
            ],
            'td'=>[
                'name'=>'desc_jig',
...
$stock_table = [
    ...
    'data_array'=> [
        ...
        [
            'th'=>[
                'body'=>'Code',
                'class'=>'bg-teal-700 border-2 text-white uppercase border-black p-2 sticky left-0 top-0 z-20 w-[20vw]',
            ],
            'type'=>'input',
            'td'=>[
            ...
            'inp'=>[
                ...
                'disable'=>'',
                'name'=> 'code', 
                'class'=>'w-full rounded h-full focus:ring focus:ring-teal-600 focus:ring-width-1 focus:outline focus:bg-slate-200 focus:outline-teal-600 bg-transparent px-4 hidden'
            ]
        ],
        [
            'th'=>[
                'body'=>'Lokasi',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[15vw]'
            ],
            'type'=>'input',
            'td'=>[
        ...
        [
            'th'=>[
                'body'=>'Quantity OH',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[12vw]'
            ],
            'type'=>'input',
            'td'=>[
        ...
        [
            'th'=>[
                'body'=>'Tambah/Kurang',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[8vw]'
            ],
            'type'=>'select',
            'td'=>[
            ...
            'select'=>[
                'name'=> 'addSub', 
                'class'=>'w-full h-full focus:ring focus:ring-teal-600 focus:ring-width-1 focus:outline focus:bg-slate-200 focus:outline-teal-600 bg-slate-300 px-4 hidden'
            ],
            'option'=>[
        ...
        [
            ...
            'inp'=>[
                ...
                'placeholder'=>'',
                'name'=> 'qty_change', 
                'class'=>'w-full rounded h-full focus:ring focus:ring-teal-600 focus:ring-width-1 focus:outline focus:bg-slate-200 focus:outline-teal-600 bg-slate-100 px-4 hidden'
            ]
        ],
        [
            'th'=>[
        ...
        [
            'th'=>[
                'body'=>'Remark',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[23vw]'
            ],
            'type'=>'input',
            'td'=>[
        ...
        [
            'th'=>[
                'body'=>'Delete',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[6vw]'
            ],
            'type'=>'set_btn',
            'td'=>[
                'data_attr'=>['field::btn_set'],
...
$stock_table_hist = [
    ...
    'data_array'=> [
        [
            'th'=>[
                'body'=>'Code',
                'class'=>'bg-teal-500 border-2 uppercase border-black p-2 sticky left-0 top-0 z-20 w-[20vw]'
            ],
            'type'=>'text', 
            'td'=>[
                'name'=>'code',
        ...
        [
            'th'=>[
                'body'=>'Lokasi',
                'class'=>'bg-teal-300 border-2 uppercase border-black p-2 sticky top-0 z-10 w-[8vw]',
            ],
            'type'=>'text', 
            'td'=>[
                'name'=>'lokasi',
        ...
        [
            'th'=>[
                'body'=>'Tambah/Kurang',
                'class'=>'bg-teal-300 border-2 uppercase border-black p-2 sticky top-0 z-10 w-[12vw]',
            ],
            'type'=>'text',
            'td'=>[
                'name'=> 'addSub',
...
$dtl_new_hist = [
    ...
    'data_array'=> [
        [
            'th'=>[
                'body'=>'Item Jig',
                'class'=>'bg-teal-500 border-2 uppercase border-black p-2 sticky left-0 top-0 z-20 w-[12vw]'
            ],
            'type'=>'text', 
            'td'=>[
                'name'=>'item_jig',
        ...
        [
            'th'=>[
                'body'=>'Remark',
                'class'=>'bg-teal-300 border-2 uppercase border-black p-2 sticky top-0 z-10 w-[20vw]',
            ],
            'type'=>'text',
            'td'=>[
                'name'=> 'remark',
...
$type_table_upd = [
    ...
    'data_array'=> [
        ...
        [
            'th'=>[
                'body'=>'Item Number jig',
                'class'=>'bg-teal-700 border-2 text-white uppercase border-black p-2 sticky left-0 top-0 z-20 w-[18vw]'
            ],
            'type'=>'input',
            'td'=>[
        ...
        [
            'th'=>[
                'body'=>'Deskripsi Jig',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[18vw]'
            ],
            'type'=>'input',
            'td'=>[
        ...
        [
            'th'=>[
                'body'=>'Delete',
                'class'=>'bg-teal-600 border-2 text-white uppercase border-black p-2 sticky top-0 z-10 w-[10vw]'
            ],
            'type'=>'set_btn',
            'td'=>[
                'data_attr'=>['field::btn_set'],
...
$type_table_hist = [
    ...
    'data_array'=> [
        [
            'th'=>[
                'body'=>'Item Jig',
                'class'=>'bg-teal-500 border-2 uppercase border-black p-2 sticky left-0 top-0 z-20 w-[18vw]'
            ],
            'type'=>'text',
            'td'=>[ 
                'name'=>'item_jig',
        ...
        [
            'th'=>[
                'body'=>'Put On Ops',
                'class'=>'bg-teal-300 border-2 uppercase border-black p-2 sticky top-0 z-10 w-[18vw]',
            ],
            'type'=>'text',
            'td'=>[
                'name'=> 'opt_on',
        ...
        [
            'th'=>[
                'body'=>'Transaction Date',
                'class'=>'bg-teal-300 border-2 uppercase border-black p-2 sticky top-0 z-10 w-[10vw]',
            ],
            'type'=>'text',
            'td'=>[
                'name'=> 'trans_date',
