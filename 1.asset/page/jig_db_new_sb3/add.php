...
$add = Comp::dtlist(['id'=>'loc_list'])
    ...
    ".Comp::aside([
        'class'=>'fixed top-[5vh] w-[20vw] bg-teal-800 h-[95vh]',
        'body'=>[
            Comp::div([
                'id'=>'jig_switch',
                'class'=>'flex cursor-pointer hover:bg-teal-600 justify-center items-center h-[10vh] w-full text-white items-center duration-300 hover:text-xl hover:font-bold bg-teal-600 text-xl font-bold',
                'body'=>'New Jig'
            ]),
            Comp::div([
                'id'=>'speaker_switch',
                'class'=>'flex cursor-pointer hover:bg-teal-600 justify-center items-center h-[10vh] w-full text-white items-center duration-300 hover:text-xl hover:font-bold bg-teal-800 ',
                'body'=>'New Speaker'
            ]),
            Comp::div([
                'id'=>'loc_switch',
        ...
        'body'=>[
            Comp::div([
                ...
                'body'=>[
                    ...
                    Comp::button([
                        'id'=>'add_loc_row',
                        'class'=>'border-2 bg-gray-400 hover:bg-teal-700 active:bg-teal-500 hover:text-white hover:font-bold hover:text-lg rounded broder-slate-300 duration-300',
