            ...
            Comp::div([
                ...
                'body'=>[
                    Comp::div([
                        ...
                        'class'=>'flex cursor-pointer hover:bg-teal-600 justify-center items-center h-[5vh] w-[50%] items-center duration-300 hover:text-xl hover:font-bold text-white bg-teal-600 text-xl font-bold',
                        'body'=>'Detail Lokasi'
                    ]),
                    Comp::div([
                        'id'=>'detail_type_switch',
                        'class'=>'flex cursor-pointer hover:bg-teal-600 justify-center items-center h-[5vh] w-[50%] items-center duration-300 hover:text-xl hover:font-bold text-white bg-teal-800 ',
                        'body'=>'Detail Usage'
                    ]),
                ]
            ]),
        ...
        'body'=>[
            Comp::div([
                ...
                'body'=>[
                    Comp::div([
                        'id'=>'jig_switch',
                        'class'=>'flex cursor-pointer hover:bg-teal-600 justify-center items-center h-[5vh] w-[50vw] items-center duration-300 hover:text-xl hover:font-bold text-white bg-teal-600 text-xl font-bold',
                        'body'=>'Jig Based Search'
                    ]),
                    Comp::div([
                        'id'=>'type_switch',
                        'class'=>'flex cursor-pointer hover:bg-teal-600 justify-center items-center h-[5vh] w-[50vw] items-center duration-300 hover:text-xl hover:font-bold text-white bg-teal-800 ',
