    ...
    'body'=>
        ...
        ".Comp::header([
            ...
            'body'=>[
                Comp::input([
                    'id'=>'tracker_search',
                    'class'=>'flex rounded px-2 text-sm h-[1.6rem] focus:ring focus:ring-blue-400 focus:ring-width-4 focus:outline focus:outline-blue-400 duration-300 shadow-md w-[15vw]'
                ]),
                Comp::button([
