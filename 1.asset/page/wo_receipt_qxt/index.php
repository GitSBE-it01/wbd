...
INDEX HTML
=============================================================================== */
$nav_array['title'] = 'WO Receipt Backflush';

createHTML([
    'name'=>'index', 
    'title'=>"WO Receipt Backflush",
    'path'=>'wo_receipt_qxt',
    'body'=>
        $load2."
        ".Comp::nav([
        ...
        ".Comp::main([
            ...
            'body'=>[
                Comp::div([
                    'id'=> 'header_main',
                    'class'=>'w-full h-[15vh] px-4 pb-2 flex flex-row bg-slate-500 ',
                    'body'=>[
                        Comp::div([
                            'class'=>'h-full w-[50%]',
                            'body'=>[
                                create_formset($detail_form1)
                            ]
                        ]),
                        Comp::div([
                            'class'=>'h-full w-[50%]',
                            'body'=>[
                                create_formset($detail_form2)
                            ]
                        ]),
                    ]
                ]),
